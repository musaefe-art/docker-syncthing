...
* [1.30.0](https://hub.docker.com/r/11notes/syncthing/tags?name=1.30.0)
...
# REGISTRIES ☁️
```
docker pull 11notes/syncthing:1.30.0
docker pull ghcr.io/11notes/syncthing:1.30.0
docker pull quay.io/11notes/syncthing:1.30.0
```
...
*created 06.08.2025, 22:10:14 (CET)*